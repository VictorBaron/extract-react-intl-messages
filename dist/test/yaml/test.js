...
const yamlLoad = (tmp, file = '') =>
  js_yaml_1.default.safeLoad(
    fs_1.default.readFileSync(path_1.default.resolve(tmp, file), 'utf8')
  )
...
test('exsit yaml', async () => {
  ...
  const tmpEn = temp_write_1.default.sync(
    js_yaml_1.default.safeDump(x),
    'en.yml'
  )
  ...
  expect(
    js_yaml_1.default.safeLoad(fs_1.default.readFileSync(tmpEn, 'utf8'))
  ).toMatchSnapshot()
  const tmpJa = temp_write_1.default.sync(
    js_yaml_1.default.safeDump(x),
    'ja.yml'
  )
  ...
  expect(
    js_yaml_1.default.safeLoad(fs_1.default.readFileSync(tmpJa, 'utf8'))
  ).toMatchSnapshot()
})
