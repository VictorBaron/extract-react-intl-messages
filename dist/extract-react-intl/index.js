...
const babel_plugin_react_intl_1 = __importDefault(
...
const getBabelrcDir = cwd =>
  path_1.default.dirname(read_babelrc_up_1.default.sync({ cwd }).path)
...
exports.default = async (
  ...
  var {
    ...
    pluginOptions = __rest(_a, ['defaultLocale', 'withDescriptions', 'cwd'])
  ...
  presets.unshift({
    plugins: [[babel_plugin_react_intl_1.default, pluginOptions]]
  })
  const extractFromFile = async file => {
    ...
    const { metadata } = await pify_1.default(core_1.transformFile)(
      file,
      babelOpts
    )
  ...
  return arr.reduce(
    (h, obj) => lodash_merge_1.default(h, obj),
    localeMap(locales)
  )
}
